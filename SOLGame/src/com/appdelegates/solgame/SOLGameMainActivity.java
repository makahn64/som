...
import com.appdelegates.solgame.AttractAnimation.AttractAnimListener;
import com.appdelegates.solgame.HandsetController.HandsetControllerListener;
import com.appdelegates.solgame.SOLGameEngineThread.UiStateChangeListener;
...
public class SOLGameMainActivity extends Activity implements HandsetControllerListener {
	
	public static Boolean DEBUG = false;
	public static Boolean ADD_PLACEHOLDER_SCORES = true;
	
	public static final Boolean PLAY_MUSIC = true;
	
	public static final int MSPF = 20; // millisecond per frame. 66 = 15fps.
	
	public static final String CNAME = "SOLGame";
	...
	protected void onResume(){
		...
		if (ADD_PLACEHOLDER_SCORES)
			stats.insertTestScoresAroundTime(1000, ""+mIPOffset);
	...
	public void enterAttractState(){
		...
		attractAnim = new AttractAnimationDots(handsetController);
	...
	public void startGame(){
		...
		switch (gameEngineIndex ){
		case 0:
			currentGameEngine = new SOLSweepSOLGameEngineThread(handsetController);
			break;
		case 1: 
			currentGameEngine = new FaultTolerantSOLGameEngineThread(handsetController);
			break;
		}
		...
		int musicResource = currentGameEngine.getMusicResource();
		if (musicResource > 0) {
