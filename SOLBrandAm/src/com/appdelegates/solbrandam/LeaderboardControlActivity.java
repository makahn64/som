...
public class LeaderboardControlActivity extends Activity {
	...
	private void fetchCurrentScores() {
		...
		try {
			final TCPClient tcpc = new TCPClient("192.168.1.100", 6565);
			final TCPClient tcpc2 = new TCPClient("192.168.1.200", 6565);
			...
			tcpc2.setTCPClientListener(new TCPClientListener(){

					@Override
					public void connectionEstablished(Handler handler) {
						tcpc2.sendMessage("getT10All");
					...
					@Override
					public void connectionFailed(Exception e) {
						toastMe("Could not get scores from 192.168.1.200");
					}
